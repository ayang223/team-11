        ...
        if (file == null) {
            ...
            reader.onload = function() {
                ...
                $.ajax({
                    url: url,
                    type: "POST",
                    data: JSON.stringify({"action": "Import Programs", "data": parsed.data}),
                    dataType: "json",
        ...
        if (file == null) {
            ...
            reader.onload = function() {
                ...
                $.ajax({
                    url: url,
                    type: "POST",
                    data: JSON.stringify({"action": "Import Output", "data": parsed.data}),
                    dataType: "json",
                    success: function(data) {
                        if (data.status === 'failed') {
                            alert("Error Message: Something happened during the request to send data from server, please contact your Administrator");
            ...
            <div style={innerStyle}>
                ...
                <div className="row" style={{
                    ...
                    <p className="help-text" style={{
                        margin: "5px",
                        textAlign: "center"
                    }}>You can import new Andar Data below. Please click the appropriate upload button depending on the data you are uploading</p>
                    <div style={{
                        ...
                        <form ref="uploadForm" className="uploader" encType="multipart/form-data">
                            ...
                            <p className="help-text" style={{
                                ...
                                If this is the first time in the year that Andar data is uploaded, please upload the Output .csv file first before the Program.
                            </p>
                    ...
                    <div style={{
                        ...
                        <div id="errorOut" style={{
                            margin: "20px"
                        }}>Status of upload will be displayed here {this.state.loading == 1 && <div style={{
                                width: "200px",
                                height: "200px"
