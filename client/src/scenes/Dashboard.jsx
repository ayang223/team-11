...
class Dashboard extends React.Component {
    ...
    generateGraphs() {
        ...
        var allFilters = filterByYear.concat(filterByCity, filterByInvested, filterByAgency, filterByFocusArea, filterByPopulation, filterByElement, filterByEngagement);
        var filterString = allFilters.join(", ");
        $.ajax({
            url: url,
            type: "POST",
            data: JSON.stringify({"action": "Log Filter", "user": username, "filters": filterString}),
            dataType: "json",
        ...
        if (this.state.data) {
            return (
                <div>
                    ...
                    <div>
                        <div className="row">
                            <FilterByInvested ref={filterbyinvested => {
                                this._filterByInvested = filterbyinvested
                            }} data={this.state.data}/>

                        </div>
                        <div className="row">
                            <FilterByYear ref={filterbyyear => {
                                this._filterByYear = filterbyyear
                            }} data={this.state.data}/>
                            <FilterByCity ref={filterbycity => {
                                this._filterByCity = filterbycity
                            }} data={this.state.data}/>
                            <FilterByAgency ref={filterbyagency => {
                                this._filterByAgency = filterbyagency
                            }} data={this.state.data}/>
                            <FilterByPopulation ref={filterbypopulation => {
                                this._filterByPopulation = filterbypopulation
                            }} data={this.state.data}/>
                            <FilterByEngagement ref={filterbyengagement => {
                                this._filterByEngagement = filterbyengagement
                            }} data={this.state.data}/>
                        </div>
                        <div className="row">
                            <FilterByFocusArea ref={filterbyfocusarea => {
                                this._filterByFocusArea = filterbyfocusarea
                            }} data={this.state.data}/>

                            <hr />
                            <FilterByElement ref={filterbyelement => {
                                this._filterByElement = filterbyelement
                            }} data={this.state.data}/>
                        </div>
                        <hr />
                        <div className="row">
                    ...
                    <div>
                        <Tabs forceRenderTabPanel={true}>
                            ...
                            <TabPanel>
                                <ChartMoneyInvested ref={chartmoneyinvested => {
                                    this._chartMoneyInvested = chartmoneyinvested
                                }} data={this.state.filterData}/>
                            </TabPanel>
                            <TabPanel>
                                <ChartSumClientsServed ref={chartsumclientsserved => {
                                    this._chartSumClientsServed = chartsumclientsserved
                                }} data={this.state.filterData}/>
                            </TabPanel >
                            <TabPanel>
                                <ChartGeographicInvestedCityGrouping ref={chartgeographicinvestedcitygrouping => {
                                    this._chartGeographicInvestedCityGrouping = chartgeographicinvestedcitygrouping
                                }} data={this.state.filterData}/>
                            </TabPanel>
                        </Tabs>
                    </div>
                    ...
                    <Tabs forceRenderTabPanel={true}>
                        ...
                        <TabPanel>
                            <TableProgramInfo ref={tableprograminfo => {
                                this._tableProgramInfo = tableprograminfo
                            }} data={this.state.filterData}/>
                        </TabPanel>
                        <TabPanel>
                            <Listing ref={listing => {
